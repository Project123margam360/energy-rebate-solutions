  ...
  return (
    <div className="fixed right-4 bottom-6 z-50 flex flex-col gap-3">
      ...
      <a
        ...
        className="w-14 h-14 rounded-full bg-[#25D366] hover:bg-[#1ebe5b] text-white flex items-center justify-center shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all"
      >
